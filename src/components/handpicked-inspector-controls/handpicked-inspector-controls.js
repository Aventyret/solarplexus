...
import { PanelBody, Card, CardBody, Button } from '@wordpress/components';
...
const HandpickedInspectorControls = ( {
	attributes,
	setAttributes,
	config,
	setIsDirty,
	...
	const removeSearchResult = ( searchResultId ) => {
		setAttributes( {
			searchResults: attributes.searchResults.filter(
				( searchResult ) => {
