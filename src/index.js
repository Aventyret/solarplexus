...
const getCustomSvgJsx = (icon) => {
  return function() {
    return <span className="splx-icon" dangerouslySetInnerHTML={{ __html: icon }} />;
  };
};
