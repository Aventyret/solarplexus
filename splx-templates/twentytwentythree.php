...
<div class="has-global-padding is-layout-constrained wp-block-query alignwide">
	<ul class="is-layout-flow is-flex-container columns-<?php echo $columns; ?> alignwide splx-wp-block-post-template">
  	...
  	setup_postdata($post); ?>
		<li class="wp-block-post post-<?php the_ID(); ?> post type-<?php echo get_post_type(); ?> status-publish<?php if (
 	has_post_thumbnail()
   ...
   ): ?><p class="wp-block-post-excerpt"><?php echo get_the_excerpt(); ?></p><?php endif; ?>
			<?php if (
